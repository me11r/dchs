...
class CreateChronology101FromFdsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('chronology101_from_fds', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('chronology101_from_fds');
    }
}
