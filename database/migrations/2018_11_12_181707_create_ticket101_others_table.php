...
class CreateTicket101OthersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ticket101_others', function (Blueprint $table) {
            $table->increments('id');

            $table->unsignedInteger('ticket_101_id');
    ...
    {
        Schema::dropIfExists('ticket101_others');
    }
}
