...
class CreateCard102RoadtripPlansTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('card102_roadtrip_plans', function (Blueprint $table) {
            $table->increments('id');

            $table->unsignedInteger('card102_id')->nullable();
    ...
    {
        Schema::dropIfExists('card102_roadtrip_plans');
    }
}
