                    ...
                    <div :style="{'display': currentTabIndex === 0 ? 'block': 'none'}">
                        ...
                        <div class="field is-grouped">
                            ...
                            <div
                                ...
                                style="">
                                <p class="control">
                                    <label for="patient_name">ФИО больного</label>
                                </p>
                                <input type="text" class="input" id="patient_name" name="patient_name" v-model="model.patient_name">
                            </div>
                            <!--ВОЗРАСТ-->
                            <div
                                    class="control"
                                    style="">
                                <p class="control">
                                    <label for="patient_age">Возраст</label>
                                </p>
                                <input type="text" class="input" id="patient_age" name="patient_age" v-model="model.patient_age">
                            </div>
                            <div class="control">
                                <p class="control">
...
import {Card103utils} from './card103utils.js';
...
export default {
    ...
    data() {
        return {
            ...
            method: 'POST',
            formRoute: '',
            card112Utils: Card103utils,
            yandexMapsBus: {},
            currentCity: 'Алматы',
            servicePlans: [],
            services: [],
            departments_: [
                {name: 'hospital7', title: 'Городская клиническая больница №7'}
            ],
            departmentsToSend: [
                {name: 'linear', title: 'Линейное'},
                {name: 'special', title: 'Специализированное'},
                {name: 'neonatal', title: 'Неонатальное'},
                {name: 'gynecological', title: 'Акушерско-гинекологическое'},
            ],
            servicesTabIndex: 0
        };
    },
    ...
    methods: {
        ...
        checkServices() {
            ...
            if (window.cardFormData) {
                setInterval(function() {
                    axios
                        .post('/card103/service-plans/check', {
        ...
        setTab(tabIndex) {
            if (window.cardFormData.model.id === 0 || window.cardFormData.model.id === undefined) {
                let form = document.getElementById('card103_form');
        ...
        sendOneDepartment(event, deptName) {
            ...
            axios.post('/card103/send-department', {
