            ...
            <div class="box" style="margin-top: 20px">
                ...
                <form>
                    ...
                    <div class="field">
                        ...
                        <select @change="selectName" class="select" name="" id="vehicles">
                            <option
                                    v-model="selected_id"
                    ...
                    <div class="field">
                        ...
                        <input @blur="selectPeriod" v-model="date_begin_" type="date">
                    </div>
                    <div class="field">
                        <label for="">Конец периода</label>
                        <input @blur="selectPeriod" v-model="date_end_" class="date" type="date">
                    </div>
                    <table class="table">
                        <thead>
                            <tr>
