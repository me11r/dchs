...
class Ticket112PeriodExcelExport
{
    ...
    private function addTableData(Worksheet $sheet, $startRowIndex = 2)
    {
        ...
        $arr = [
            ...
            $this->stat['Итог']['injured'] . ' / ' . $this->stat['Итог']['injured_children'],
            $this->stat['Итог']['dead'] . ' / ' . $this->stat['Итог']['dead_children'],
            $this->stat['Итог']['evacuated'] . ' / ' . $this->stat['Итог']['evacuated_children'],
            $this->stat['Итог']['hospitalized'] . ' / ' . $this->stat['Итог']['hospitalized_children'],
            $this->stat['Итог']['injured_hard'] . ' / ' . $this->stat['Итог']['injured_hard_children'],
            $this->stat['Итог']['poisoned'] . ' / ' . $this->stat['Итог']['poisoned_children'],
            $this->stat['Итог']['saved'] . ' / ' . $this->stat['Итог']['saved_children'],
