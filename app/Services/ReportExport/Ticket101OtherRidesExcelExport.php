...
class Ticket101OtherRidesExcelExport
{
    ...
    private function prepareSpreadsheet()
    {
        ...
        $sheet->setTitle('Общий свод по прочим выездам');
    ...
    private function addFirstTableHeaders(Worksheet $sheet)
    {
        // заголовки таблицы
        $sheet->getCell('B1')
            ->setValue("Общий свод по прочим выездам за {$this->data['dateFrom']} по {$this->data['dateTo']}");
